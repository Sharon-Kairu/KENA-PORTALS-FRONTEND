...
export const practicals: Practical[] = [
  ...
  // ===== Computer =====
  {
    ...
    features: [
      // Completed (5)
      { title: "1. Introduction to Computers", date: "2024-08-01", status: "Completed", comment: "Excellent" },
      { title: "2. Computer Systems & Hardware", date: "2024-08-03", status: "Completed", comment: "Good" },
      { title: "3. Microsoft Windows", date: "2024-08-05", status: "Completed", comment: "Fair" },
      { title: "4. Microsoft Word", date: "2024-08-07", status: "Completed", comment: "Excellent" },
      { title: "5. Microsoft Excel", date: "2024-08-09", status: "Completed", comment: "Good" },
      // Pending (5)
      { title: "6. Microsoft Access", date: "N/A", status: "Pending", comment: "N/A" },
      { title: "7. Microsoft Publisher", date: "N/A", status: "Pending", comment: "N/A" },
      { title: "8. PowerPoint", date: "N/A", status: "Pending", comment: "N/A" },
      { title: "9. Email and Internet", date: "N/A", status: "Pending", comment: "N/A" },
      { title: "10. Computer Maintenance", date: "N/A", status: "Pending", comment: "N/A" },
    ],
  },
  ...
  // ===== AI =====
  {
    ...
    features: [
      // Completed (4)
      { title: "1. Introduction to AI & its Basics", date: "2024-09-01", status: "Completed", comment: "Excellent" },
      { title: "2. Prompt Engineering", date: "2024-09-03", status: "Completed", comment: "Good" },
