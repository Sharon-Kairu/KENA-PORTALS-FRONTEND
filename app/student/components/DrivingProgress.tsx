...
const DrivingProgress = ({ practical }: Props) => {
  ...
  if (per === 100) {
    message = "Congratulations! You have completed all practicals!"
    ...
    <div className="p-4 md:p-6">
      ...
      <div className={`p-4 rounded-lg mb-6 ${bgColor}`}>
        ...
        <p className={`mt-2 ${textColor}`}>
          {message} <br />
          You have completed {completed} out of {total} practicals. <br />
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full border border-gray-200 rounded-lg">
          <thead className="bg-gray-100">
            <tr>
              <th className="text-left p-3 border-b border-gray-300">Practical</th>
...
export default DrivingProgress
