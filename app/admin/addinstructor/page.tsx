...
const Page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload: any = {
      ...
      license_number: instructorData.license_number,  // Optional for driving instructors
      // instructor_id auto-generated by backend
    ...
    // Only include category for driving instructors
    ...
    try {
      ...
      const errorMessage = err.message || 'Failed to register instructor';
